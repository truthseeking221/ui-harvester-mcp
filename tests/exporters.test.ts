...
import { exportCssVariables, exportDtcgJson, exportDesignTokens, exportThemeObject, buildUniversalPackageArtifacts, exportComponentRecipes } from "../src/exporters.js";
  ...
  return {
    ...
    tokens: {
      core: {
        ...
        fontFamilies: [{ name: "body", stack: "Inter, Arial, sans-serif", weight: "400", count: 1, provenance: ["fixture"] }],
        textStyles: [
          {
            name: "body",
            fontFamily: "Inter",
